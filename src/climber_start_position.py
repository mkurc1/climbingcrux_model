...
class ClimberStartPosition:
    ...
    def prepare(self, climber_height_in_cm: int,
        ...
        self.climber.left_shoulder = BodyPart(
        ...
        self.climber.right_shoulder = BodyPart(
        ...
        self.climber.left_leg = BodyPart(
        ...
        self.climber.right_leg = BodyPart(
        ...
        self.climber.left_hand = self.__find_hold_for_left_hand(body_proportion, position_between_starting_steps)
    ...
    def __find_hold_for_left_hand(self, body_proportion: BodyProportion,
        ...
        holds = objects_detector.get_objects_around_point(
            ...
            point=self.climber.left_shoulder.start,
            radius=int(body_proportion.arm)
        )

        # exclude holds that are on the right side of the position_between_starting_steps
        holds = [hold for hold in holds if hold.get_center()[0] < position_between_starting_steps]
        ...
        return BodyPart(
            start=self.climber.left_shoulder.start,
    ...
    def __find_hold_for_right_hand(self, body_proportion: BodyProportion,
        ...
        holds = objects_detector.get_objects_around_point(
            detected_objects=self.detected_objects,
            point=self.climber.right_shoulder.end,
            radius=int(body_proportion.arm)
        )
        ...
        return BodyPart(
            start=self.climber.right_shoulder.end,
